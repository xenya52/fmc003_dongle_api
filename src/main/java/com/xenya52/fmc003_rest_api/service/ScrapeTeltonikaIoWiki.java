...
public class ScrapeTeltonikaIoWiki {
    ...
    private IoWikiModel[] dataSendingParametersJson;

    // Constructors
    public ScrapeTeltonikaIoWiki() {
        // dont do this! this.dataSendingParameters = fetchdataSendingParameters();
        // dont do this! this.dataSendingParametersJson = getIoWikiResponses();
    }
    ...
    public String getDataSendingParametersJson() {
        ...
        for (int i = 0; i < dataSendingParametersJson.length; i++) {
            // Debugging
            System.out.println(dataSendingParametersJson[i].toString());

            jsonList.append(dataSendingParametersJson[i].toString());
     ...
     */
    private IoWikiModel[] getIoWikiResponses() {
        // Debugging
        System.out.println(dataSendingParameters);

        IoWikiModel[] ioWikiResponses = new IoWikiModel[getIdAndName().size()];
        try {
